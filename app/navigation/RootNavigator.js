    ...
    const getToken = async () => {
        try {
            ...
            if (userToken !== null) {
                ...
                const { name: givenName, lastname: familyName, nickname: nickName, email, photo, id } = response.user;
                dispatch(logIn({givenName, familyName, nickName, email, photo, token, id}));
